...
def assign_track_color(track):
    ...
    for track_color_key, track_color_value in lower_case_track_colors.items():
        if track_color_key in track_name:
            color_index = lower_case_track_colors[track_color_key]
...
class TrackColorChanger(ControlSurface):
